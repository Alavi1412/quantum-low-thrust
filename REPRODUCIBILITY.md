...
- Independent-HS multi-epoch cached-Horizons Earth/Moon/Sun point-mass
  ...
  validation, production solver parity, fuel optimality, DOI evidence, or
  quantum evidence.
- Independent-HS SPICE-derived ephemeris replay:
  ...
  full high-fidelity/flight validation, production solver parity, fuel
...
- Independent-HS CasADi/IPOPT bridge check:
  ...
  `0.0`. This is a scoped mature NLP backend bridge check, not production
