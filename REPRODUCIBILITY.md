...
- Reviewer-facing claim evidence ledger:
  ...
  branch-control replay row, the focused tail-coast branch-control replay row,
  the Horizons force-model contrast row, the negative bicircular solar-tidal
  stress row, and the completed negative bicircular retuned recovery row because
  their real artifacts exist.
- Cross-backend evidence synthesis and practitioner lessons:
  ...
  branch-control replay row when its real replay CSV and metadata exist.
