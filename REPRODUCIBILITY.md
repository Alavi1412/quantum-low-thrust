...
- Tail-coast fixed-final-time hard-catalog recovery diagnostic
  ...
  accepted for 4 branches, and the two no-recovery-variable late-tail branches
  are threshold-feasible direct evaluations rather than optimizer convergence;
