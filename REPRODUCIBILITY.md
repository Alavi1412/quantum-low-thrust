...
- Reviewer-facing claim evidence ledger:
  ...
  phase-sweep stress row, the focused tail-coast branch-control replay row, the
...
- Cross-backend evidence synthesis and practitioner lessons:
  ...
  stress row when their real replay CSV and metadata exist.
